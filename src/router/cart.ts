...
import { 
    ...
    clearCartController} from '../controllers/cart';

export default (router: express.Router) => {
    router.post('/users/:userId/cart', isAuthenticated, verifyUserMatch, createCartForUser);
    ...
    router.delete('/users/:userId/cart', isAuthenticated, verifyUserMatch, clearCartController);
}